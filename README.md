# 🚆 Train Station ChatOps — La Station Genval (v0.1.2)
...
* **PWA & Résilience Offline :** L'App Shell est pré-mis en cache (`kiosk-chatops-v0.1.2`). En cas de coupure réseau, une bannière ambre explicite s'affiche et le dernier planning reste consultable.
